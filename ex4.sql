...
ALTER TABLE profile ADD CONSTRAINT profile_fk_1 
...
CREATE TABLE community_post (
    ...
    FOREIGN KEY (from_user_id) REFERENCES users(id),
    FOREIGN KEY (to_name_community) REFERENCES communities(id)
);
...
CREATE TABLE community_members (
    ...
    FOREIGN KEY (name_community) REFERENCES communities(id)
);
